...
export const CONFIG = {
  ...
  teamCodes: {
    ...
    BOS: { sv: "Bosnien",         en: "Bosnia-Herzegovina",    iso: "BA",  aliases: ["Bosnia and Herzegovina"] },
    ...
    ELF: { sv: "Elfenbenskusten", en: "Côte d'Ivoire",         iso: "CI",  aliases: ["Ivory Coast"] },
    ...
    IRN: { sv: "Iran",            en: "Iran",                  iso: "IR",  aliases: ["IR Iran"] },
    JOR: { sv: "Jordanien",       en: "Jordan",                iso: "JO" },
    JPN: { sv: "Japan",           en: "Japan",                 iso: "JP" },
    KAN: { sv: "Kanada",          en: "Canada",                iso: "CA" },
    KAP: { sv: "Kap Verde",       en: "Cape Verde Islands",    iso: "CV",  aliases: ["Cape Verde"] },
    KON: { sv: "Kongo",           en: "Congo DR",              iso: "CD",  aliases: ["DR Congo", "Democratic Republic of Congo"] },
    KOR: { sv: "Sydkorea",        en: "Korea Republic",        iso: "KR",  aliases: ["South Korea"] },
    ...
    TJE: { sv: "Tjeckien",        en: "Czechia",               iso: "CZ",  aliases: ["Czech Republic"] },
    TUN: { sv: "Tunisien",        en: "Tunisia",               iso: "TN" },
    TUR: { sv: "Turkiet",         en: "Türkiye",               iso: "TR",  aliases: ["Turkey"] },
